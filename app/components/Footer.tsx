  ...
  return (
    <footer className="bg-gate-black border-t border-gate-border py-12 px-4" style={{ fontFamily: "NeueHaasDisplay", fontWeight: 300 }}>
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8">
        <div>
          <h4 className="text-[0.9rem] uppercase tracking-normal mb-3" style={{ fontFamily: "NeueHaasDisplay", fontWeight: 900 }}>Contact Us</h4>
        ...
        <div>
          <h4 className="text-[0.9rem] uppercase tracking-normal mb-3" style={{ fontFamily: "NeueHaasDisplay", fontWeight: 900 }}>Careers</h4>
        ...
        <div>
          <h4 className="text-[0.9rem] uppercase tracking-normal mb-3" style={{ fontFamily: "NeueHaasDisplay", fontWeight: 900 }}>Get Direction</h4>
        ...
        <div>
          <h4 className="text-[0.9rem] uppercase tracking-normal mb-3" style={{ fontFamily: "NeueHaasDisplay", fontWeight: 900 }}>Live</h4>
          <a href="mailto:live@gatemilano.com" className="text-sm text-gate-muted hover:text-gate-white transition-colors">
            live@gatemilano.com
          </a>
        </div>
        <div>
          <h4 className="text-[0.9rem] uppercase tracking-normal mb-3" style={{ fontFamily: "NeueHaasDisplay", fontWeight: 900 }}>Corporate</h4>
